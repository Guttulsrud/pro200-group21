      ...
      >
        ...
        <Div mx={15} my={10}>
          ...
          <DestField borderTop="#616567" display="flex" alignItems="center" justifyContent="center">
            ...
            <Text.p color={'#616567'} m={0} p={0} style={{ overflowWrap: "break-word" }}>{props.ticketdata.route.destination.title}</Text.p>
          </DestField>
        </Div>

        <Div mx={15} my={10}>
          {props.ticketdata.expiration < Date.now() ? <Status inactive onClick={toggleReceipt}>Utgått</Status> :
